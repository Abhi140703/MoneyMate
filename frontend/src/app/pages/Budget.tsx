...
import { Plus, Wallet, AlertTriangle, CheckCircle, Edit, Trash2 } from 'lucide-react';
...
export function Budget() {
  ...
  const handleAddBudget = () => {
    ...
    addBudget({ category, amount: parseFloat(amount), month: currentMonth });
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">Plan and track your monthly budgets</p>
        </div>
        <Button 
...
<p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
        ...
        >
          <Card className={`border-0 shadow-xl ${
            ...
            <CardHeader className="pb-2">
              <CardTitle className={`text-sm font-medium ${remaining >= 0 ? 'text-green-100' : 'text-red-100'}`}>
                Remaining
              </CardTitle>
            </CardHeader>
            <CardContent>
 ...
 <p className={`text-sm mt-1 ${remaining >= 0 ? 'text-green-100' : 'text-red-100'}`}>
          ...
          <CardContent>
            {monthlyBudgets.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-slate-500 dark:text-slate-400">No budgets created yet</p>
                    ...
                    >
                      ...
                      {isOverBudget && (
                        <div className="flex items-center gap-2 mt-2 text-red-600 dark:text-red-400">
                          ...
                          <p className="text-sm font-medium">Over budget by {formatCurrency(budget.spent - budget.amount)}</p>
                        </div>
                      )}
                    </motion.div>
                  );
        ...
        <DialogContent className="sm:max-w-[450px]">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3 pt-4">
              ...
              <Button onClick={handleAddBudget} className="flex-1 bg-blue-600 hover:bg-blue-700">
                Create Budget
              </Button>
            </div>
          </div>
